...
class Functions
{	
	protected $loginKey = "forestrylogin";

	public $login;
	
	function __construct()
	{
		session_start($this->loginKey);
	    if (!array_key_exists($this->loginKey,$_SESSION)) {
			$_SESSION[$this->loginKey] = 0;
		}
		

		if ($_SESSION[$this->loginKey] == true) {
			$this->login = true;
		} else {
			$this->login = false;
		}
